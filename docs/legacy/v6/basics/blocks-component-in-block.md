...
* props - [JS](https://github.com/hhftechtips/eightshift-frontend-libs/blob/develop/scripts/editor/attributes.js) - [PHP](https://github.com/hhftechtips/eightshift-libs/tree/4.0.0/src/Helpers/AttributesTrait.php)
...
* getAttrKey - [JS](https://github.com/hhftechtips/eightshift-frontend-libs/blob/develop/scripts/editor/attributes.js) - [PHP](https://github.com/hhftechtips/eightshift-libs/tree/4.0.0/src/Helpers/AttributesTrait.php)
* checkAttr - [JS](https://github.com/hhftechtips/eightshift-frontend-libs/blob/develop/scripts/editor/attributes.js) - [PHP](https://github.com/hhftechtips/eightshift-libs/tree/4.0.0/src/Helpers/AttributesTrait.php)
* render - [PHP](https://github.com/hhftechtips/eightshift-libs/tree/4.0.0/src/Blocks/AbstractBlocks.php)
