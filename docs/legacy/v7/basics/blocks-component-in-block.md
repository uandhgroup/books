...
* props - [JS](https://github.com/uandhgroup/eightshift-frontend-libs/tree/6.0.0/scripts/editor/attributes.js) - [PHP](https://github.com/uandhgroup/eightshift-libs/tree/5.0.0/src/Helpers/AttributesTrait.php)
* getOptions - [JS](https://github.com/uandhgroup/eightshift-frontend-libs/tree/6.0.0/scripts/editor/options.js)
* getOption - [JS](https://github.com/uandhgroup/eightshift-frontend-libs/tree/6.0.0/scripts/editor/options.js)
* getAttrKey - [JS](https://github.com/uandhgroup/eightshift-frontend-libs/tree/6.0.0/scripts/editor/attributes.js) - [PHP](https://github.com/uandhgroup/eightshift-libs/tree/5.0.0/src/Helpers/AttributesTrait.php)
* checkAttr - [JS](https://github.com/uandhgroup/eightshift-frontend-libs/tree/6.0.0/scripts/editor/attributes.js) - [PHP](https://github.com/uandhgroup/eightshift-libs/tree/5.0.0/src/Helpers/AttributesTrait.php)
* render - [PHP](https://github.com/uandhgroup/eightshift-libs/tree/5.0.0/src/Blocks/AbstractBlocks.php)
