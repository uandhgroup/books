...
[![docs-source](https://img.shields.io/badge/source-eigthshift--boilerplate-red?style=for-the-badge&logo=wordpress&labelColor=2a2a2a)](https://github.com/uandhgroup/eightshift-boilerplate/tree/v4.0.0/webpack.config.js)
...
Look at how the config is set up on [Eightshift Boilerplate repo](https://github.com/uandhgroup/eightshift-boilerplate/tree/v4.0.0/webpack.config.js).
