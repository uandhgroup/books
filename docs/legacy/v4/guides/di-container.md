...
[![docs-source](https://img.shields.io/badge/source-eigthshift--libs-blue?style=for-the-badge&logo=php&labelColor=2a2a2a)](https://github.com/uandhgroup/eightshift-libs/tree/v2.0.0/src/class-main.php)
...
Eightshift libs are using [PHP-DI](http://php-di.org/) as an implementation of a dependency injection container. We'll explain the implementation by following the [eightshift-boilerplate](https://github.com/uandhgroup/eightshift-boilerplate/tree/v4.0.0/src/class-main.php) example.
...
Whenever a class has a dependency on another class, you'd add this dependency through a process of constructor injection. For instance, the `Enqueue_Admin` class depends on both the `Config` and `Manifest` classes. Looking at the [implementation](https://github.com/uandhgroup/eightshift-libs/tree/v2.0.0/src/enqueue/class-enqueue-admin.php) we have:
