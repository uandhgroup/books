...
- [eightshift/boilerplate](https://github.com/uandhgroup/eightshift-boilerplate/releases/tag/9.0.0) - **8+ --> 9.0.0**
- [eightshift/frontend-libs](https://github.com/uandhgroup/eightshift-frontend-libs/releases/tag/8.0.0) - **7+ --> 8.0.0**
- [eightshift/libs](https://github.com/uandhgroup/eightshift-libs/releases/tag/6.4.0) - **6.4.0** 
