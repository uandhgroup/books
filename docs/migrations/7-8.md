...
- [eightshift/boilerplate](https://github.com/hhftechtips/eightshift-boilerplate/releases/tag/8.0.0) - **7+ --> 8.0.0**
- [eightshift/frontend-libs](https://github.com/hhftechtips/eightshift-frontend-libs/releases/tag/7.0.0) - **6+ --> 7.0.0**
- [eightshift/libs](https://github.com/hhftechtips/eightshift-libs/releases/tag/6.0.0) - **5+ --> 6.0.0**

## Required changes

**Migration time: ~10min.**

1. Update `composer.json` to `"hhftechtips/eightshift-libs": "^6.0"`.
...
4. Add `.browserslistrc` to the root of your theme/plugin and copy the details from [here](https://github.com/hhftechtips/eightshift-boilerplate/blob/develop/.browserslistrc).
...
1. Check if the project is using the Storybook package `@eightshift/storybook` because we changed the release numbers. Check the [eightshift-storybook repository's releases page](https://github.com/hhftechtips/eightshift-storybook/releases) for reference. At the time of writing this, the current version is `1.4.1`.
