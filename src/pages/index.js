...
import { Hero, ImageAndText, CtaCards, TextCards, FeatureShowcase, CtaImageButton, icons } from '@hhftechtips/docusaurus-theme';
...
export default function Home() {
	...
	return (
		...
		>
			<Hero
				title='Eightshift Development Kit New 1'
