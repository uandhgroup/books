...
<figure>
  <img src="/img/blog/14/14-5.jpg" />
  <img src="/img/blog/14/14-6.jpg" />
...
Click on the Instance ID that looks like `i-xxxxxxxxxxxxxxxxx`. Next, Copy the IP Address under **Public IPv4 Address** or click on <ContentCopyRoundedIcon /> icon under **Public IPv4 Address**.

<figure>
  <img src="/img/blog/14/14-8.jpg" />
  <img src="/img/blog/14/14-9.jpg" />
...
Open Remote Desktop Connection by pressing <kbd><i className="fa-brands fa-windows" /></kbd> + R and type `mstsc` and press Enter. Then Type in your EC2 Instance Public IP Address and press Enter. Then type in your username as `ubuntu` and password as you set earlier. Then click on **OK**.

<figure>
  <img src="/img/blog/14/14-16.jpg" />
  <img src="/img/blog/14/14-17.jpg" />
...
<figure>
  <img src="/img/blog/14/14-18.jpg" />
  <img src="/img/blog/14/14-19.jpg" />
